...
const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-(--card) p-2 rounded-[25px] shadow-(--shadow-md) border border-(--border)">
        ...
        >
          ...
          <h3 className="text-2xl font-semibold text-(--text) leading-none mb-[10px]">
            {title}
          </h3>
...
export default function HowItWorksTimeline({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={`bg-(--bg) max-md:pt-10 max-md:pb-25 md:py-20 px-8 relative overflow-hidden ${className}`}
      >
        <div
        ...
        <div className="from-(--bg) pointer-events-none absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r"></div>
        <div className="from-(--bg) pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l"></div>
